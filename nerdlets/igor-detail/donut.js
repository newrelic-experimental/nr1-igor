  ...
  render() {
    ...
    return (
      <svg width="100%" height="100%" viewBox="0 0 42 42" className="donut">
        ...
        <circle className="donut-segment" cx="21" cy="21" r="15.91549430918954" fill="transparent" stroke={this.colorByPercent(pct, true)} strokeWidth="3" strokeDasharray={dashArray} strokeDashoffset="25"></circle>
        <text x="50%" y="50%" className="chart-label">{percent}</text>
      </svg>
    );
  }
}
