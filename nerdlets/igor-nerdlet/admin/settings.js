...
export default class Settings extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      mapboxAccessToken: '',
      mapDefaultsLongitude:
        ((props.settings || {}).mapDefaults || {}).longitude || '-98.5556199',
      mapDefaultsLatitude:
        ((props.settings || {}).mapDefaults || {}).latitude || '39.8097343',
      mapDefaultsZoom: ((props.settings || {}).mapDefaults || {}).zoom || '4',
      mapDefaultsPitch:
        ((props.settings || {}).mapDefaults || {}).pitch || '60',
      mapDefaultsBearing:
        ((props.settings || {}).mapDefaults || {}).bearing || '0'
    };
  ...
  resetDefauls() {
    ...
    this.setState(
      {
        mapDefaultsLongitude:
          ((settings || {}).mapDefaults || {}).longitude || '-98.5556199',
        mapDefaultsLatitude:
          ((settings || {}).mapDefaults || {}).latitude || '39.8097343',
  ...
  render() {
    ...
    return (
      <div>
        <div className="field">
          <label htmlFor="mapbox-access-token" className="label">
            Mapbox Access Token
          </label>
          {settings && 'mapboxAccessToken' in settings && (
            <div className="message info">
              <Icon
                ...
                style={{ color: '#0288d1', marginRight: '.2em' }}
              />
              Mapbox Access Token has already been set. Adding a new token will
          ...
          <div className="hint">
            ...
            , which is required to display the map.
          </div>
          <Button
            type={Button.TYPE.NORMAL}
            iconType={Button.ICON_TYPE.INTERFACE__SIGN__PLUS__V_ALTERNATE}
            onClick={() => this.saveHandler('mapboxAccessToken')}
          >
            Add
          </Button>
        </div>
          ...
          >
            <div className="col" style={{ margin: '1em' }}>
              <div className="summary">
                ...
                <a
                  href="https://docs.mapbox.com/help/glossary/camera/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  camera
                </a>
                . These are the settings used when the map first loads.
              </div>
              <div className="field">
                <label htmlFor="map-defaults-longitude" className="label">
                  longitude
                </label>
                <input
                  ...
                  onChange={e =>
                    this.textChange(e.target.value, 'mapDefaultsLongitude')
                  }
                  style={formStyle}
                />
              </div>
              <div className="field">
                <label htmlFor="map-defaults-latitude" className="label">
                  latitude
                </label>
                <input
                  ...
                  onChange={e =>
                    this.textChange(e.target.value, 'mapDefaultsLatitude')
                  }
                  style={formStyle}
                />
              </div>
              <div className="field">
                <label htmlFor="map-defaults-zoom" className="label">
                  zoom
                </label>
                <input
                  ...
                  onChange={e =>
                    this.textChange(e.target.value, 'mapDefaultsZoom')
                  }
                  style={formStyle}
                />
              </div>
              <div className="field">
                <label htmlFor="map-defaults-pitch" className="label">
                  pitch
                </label>
                <input
                  ...
                  onChange={e =>
                    this.textChange(e.target.value, 'mapDefaultsPitch')
                  }
                  style={formStyle}
                />
              </div>
              <div className="field">
                <label htmlFor="map-defaults-bearing" className="label">
                  bearing
                </label>
                <input
                  ...
                  onChange={e =>
                    this.textChange(e.target.value, 'mapDefaultsBearing')
                  }
                  style={formStyle}
                />
              </div>
              <Button
                ...
                onClick={() => this.saveHandler('mapDefaults')}
              >
                Save
              </Button>
